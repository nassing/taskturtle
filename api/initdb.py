...
with sqlite3.connect('database.db') as conn:
    ...
    conn.execute('CREATE TABLE transactions (id INTEGER PRIMARY KEY AUTOINCREMENT, sender_id INTEGER NOT NULL, receiver_id INTEGER NOT NULL, price INTEGER NOT NULL, date TEXT NOT NULL, state TEXT NOT NULL, task_id INTEGER, FOREIGN KEY(sender_id) REFERENCES users(id), FOREIGN KEY(receiver_id) REFERENCES users(id), FOREIGN KEY(task_id) REFERENCES tasks(id))')
